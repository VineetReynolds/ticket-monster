...
Verify that the property `jboss.bom.version` contains the value `6.2.0.GA` or higher:
...
If you've been following this tutorial from the first chapter, this may have been performed for you.

And if you have copied the project sources over, this should already be set to `6.2.3.GA`.
...
public class MediaManager {
    ...
    static {
        ...
        tmpDir = new File(parentDir, "org.jboss.jdf.example.ticket-monster");
        if (tmpDir.exists()) {
            if (tmpDir.isFile())
...
.src/test/java/org/jboss/jdf/example/ticketmonster/test/TicketMonsterDeployment.java
[source,java]
------------------------------------------------------------------------------------------
...
.src/test/java/org/jboss/jdf/example/ticketmonster/test/rest/VenueServiceTest.java
[source,java]
------------------------------------------------------------------------------------------
...
.src/test/java/org/jboss/jdf/example/ticketmonster/test/rest/BookingServiceTest.java
[source,java]
------------------------------------------------------------------------------------------
@RunWith(Arquillian.class)
