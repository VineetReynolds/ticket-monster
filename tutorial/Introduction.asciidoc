...
The JBoss Developer Studio installer has a (very long!) name such as `jbdevstudio-product-universal-6.0.0.GA-v20121206-1855-B186.jar`
...
[CAUTION]
==============================================================================
The specific version of the stack (e.g. `1.0.4.Final`) is very likely to 
change, so do not be surprised if the version is slightly different.

If you want to know more about the stacks and the component matrix, visit 
 link:http://www.jboss.org/jdf/stack/stacks/[the JBoss Stacks site].
==============================================================================
